...
TAG_("whatever")
{
	...
	TRY_("stuff")
	{
		...
		TRUE_(check_f<24>(0.41421356237309515, logarithm_f<-1,-1>(2L)));
		TRUE_(check_f<24>(2.41421356237309490, logarithm_f<-2,-1>(2L)));
		TRUE_(check_f<24>(0.30277563773199456, logarithm_f<-1,-1>(3L)));
		TRUE_(check_f<24>(3.30277563773199480, logarithm_f<-2,-1>(3L)));
