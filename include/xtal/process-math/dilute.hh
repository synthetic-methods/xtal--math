...
template <int N_two=0, int N_two_pi=0> XTAL_TYP dilute;
template <int N_two=0, int N_two_pi=0> XTAL_USE dilute_t = process::confined_t<dilute<N_two, N_two_pi>>;
template <int N_two=0, int N_two_pi=0> XTAL_LET dilute_f = [] (auto &&o)
XTAL_0FN {
...
struct dilute
:	process::defer<decltype(dilute_f<N_two, N_two_pi>)>
{
