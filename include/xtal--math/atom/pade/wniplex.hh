...
public:
	...
	//	using S_::S_;
		...
		XTAL_DEF_(inline)
		XTAL_NEW_(explicit)
		homotype(complex_type &&o, duplex_type &&q)
		noexcept
	...
	public:// ACCESS
		...
		XTAL_DEF_(return,inline,set)
		magnum_f(auto &&o, constant_q auto &&n)
		noexcept -> decltype(auto)
		{
			return magnum_f<XTAL_ALL_(n){}>(XTAL_REF_(o));
		}
		XTAL_DEF_(return,inline,set)
		signum_f(auto &&o, constant_q auto &&n)
		noexcept -> decltype(auto)
		{
			return signum_f<XTAL_ALL_(n){}>(XTAL_REF_(o));
		}
		...
		XTAL_FX4_(dot) (template <auto ...Ns> XTAL_DEF_(return,inline,get) magnum, magnum_f<Ns...>)
		XTAL_FX4_(dot) (template <auto ...Ns> XTAL_DEF_(return,inline,get) signum, signum_f<Ns...>)
	...
	public:// RECONSTRUCT
		...
		XTAL_FX4_(dot) (template <int N_dir=0> XTAL_DEF_(return,inline,get) resolution, resolution_f<N_dir>)
		XTAL_FX4_(dot) (template <int N_dir=0> XTAL_DEF_(return,inline,get) reflection, reflection_f<N_dir>)
		XTAL_FX4_(dot) (template <int N_dir=1> XTAL_DEF_(return,inline,get)        sum, reflection_f<N_dir>)
