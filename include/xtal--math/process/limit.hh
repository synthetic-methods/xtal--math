...
struct limit<M_app>
{
	static auto constexpr L_abs = aspect_f<unsigned>(M_app());
	static auto constexpr L_sgn = aspect_f<  signed>(M_app());
	static auto constexpr L_dir = (int) aspect_f<signed>(nearing_f(L_abs)*(L_sgn));
...
struct limit<M_dir>
{
	static constexpr auto N_dir = aspect_f<unsigned>(M_dir);
...
struct limit<M_range>
{
	...
	//	TODO: Implement `edit`?
	//	TODO: Implement smooth version (together with smooth `aspect<unsigned>`) (via `Ns...`)?
