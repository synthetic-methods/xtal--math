...
template <int M_ism, int M_car> requires in_n<M_ism, 0, 1, 2> and in_n<M_car, 0, 1>
struct unity<M_ism, M_car>
{
	...
	public:
		...
		template <int N_lim=-1>
		XTAL_DEF_(return,inline,set)
		method_f(simplex_field_q auto u)
		noexcept -> decltype(auto)
		{
			using U       = XTAL_ALL_(u);
