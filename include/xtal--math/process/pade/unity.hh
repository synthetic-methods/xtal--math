	...
	public:
		...
		noexcept -> decltype(auto)
		{
			...
			if constexpr (N_lim < 0) {
				...
				auto const    o_1 =  objective_f(modulo_f<-0>(o));
				auto const    o_2 =  objective_f(modulo_f<-1>(o));
				auto constexpr _4 = -U_fit::diplo_f(2);
				return superprocess::template method_f<N_lim>(o_2)*
					term_f(one, _4, aspect_f<unsigned>(o_1 - o_2));
			}
		}
		template <int N_lim=-1>
