	...
	public:
		...
		noexcept -> auto
		{
			...
			XTAL_0IF (0 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*0.18114206708921260e-0;
			...
			XTAL_0IF (1 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*0.41502448325181734e-0;
			...
			XTAL_0IF (2 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*0.65051629987764580e-0;
				U_alpha constexpr y2 = _dn*0.03944474710871034e-0;
			...
			XTAL_0IF (3 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*0.88375887183199590e-0;
				U_alpha constexpr y2 = _dn*0.13156850890207750e-0;
			...
			XTAL_0IF (4 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*1.10086520358652850e-0;
				U_alpha constexpr y2 = _dn*0.26813142431485410e-0;
				U_alpha constexpr y3 = _dn*0.07831573963866360e-1;
			...
			XTAL_0IF (5 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*1.33357813056109360e-0;
				U_alpha constexpr y2 = _dn*0.46539035057169720e-0;
				U_alpha constexpr y3 = _dn*0.35261607756788310e-1;
			...
			XTAL_0IF (6 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*1.54923781439012060e-0;
				U_alpha constexpr y2 = _dn*0.69848490582322830e-0;
				U_alpha constexpr y3 = _dn*0.90506751518911740e-1;
				U_alpha constexpr y4 = _dn*0.15530589255192263e-2;
			...
			XTAL_0IF (7 == N_lim) {
				...
				U_alpha constexpr y0 = _dn*1.00000000000000000e-0;
				U_alpha constexpr y1 = _dn*1.78189081352097830e-0;
				U_alpha constexpr y2 = _dn*1.00031477243997680e-0;
				U_alpha constexpr y3 = _dn*0.19176306039358512e-0;
				U_alpha constexpr y4 = _dn*0.88074505355593190e-2;
			...
			XTAL_0IF_(else) {
				...
				(void) cut_t<[] XTAL_1FN_(value) (-_fit::maxilon_f(1))>::edit_f(d);
				(void) cut_t<[] XTAL_1FN_(value) (-_fit::maxilon_f(1))>::edit_f(q);
				XTAL_IF0
