...
template <typename ...As>
using component_t = process::confined_t<component<As...>>;

template <typename ...As>
XTAL_DEF_(let)
component_f = [] XTAL_1FN_(call) (component_t<As...>::method_f);
